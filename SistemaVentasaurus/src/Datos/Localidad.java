	...
	public LinkedList<Localidad> traerLocalidades() {
		...
		try {
			...
			while (result.next()) {
				...
				localidades.add(new Localidad(Integer.parseInt(datos[0]), datos[2], Integer.parseInt(datos[3]),
						Integer.parseInt(datos[3]) - entrada.contarEntradas(Integer.parseInt(datos[0])),
	...
	public LinkedList<Localidad> traerLocalidadesXConcierto(int idConcierto) {
		...
		try {
			...
			while (result.next()) {
				...
				/*
				 * locVacia.setId(Integer.parseInt(datos[0])); locVacia.setNombre(datos[2]);
				 * locVacia.setPrecio(Double.parseDouble(datos[1]));
				 * locVacia.setCuposTotal(Integer.parseInt(datos[3]));
				 * locVacia.setCuposDisponibles(Integer.parseInt(datos[3])-Integer.parseInt(
				 * datos[4]));
				 * 
				...
				localidades.add(new Localidad(Integer.parseInt(datos[0]), datos[2], Integer.parseInt(datos[3]),
						Integer.parseInt(datos[3]) - Integer.parseInt(datos[4]), Double.parseDouble(datos[1])));
